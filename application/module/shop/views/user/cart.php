...
<div class="feat_prod_box_details">
	<?php
	$linkCategory	= URL::createShopLink('default', 'category', 'index');
	$linkSubimtForm	= URL::createShopLink('default', 'user', 'buy');
	...
	if (!empty($this->Items)) {
		...
		foreach ($this->Items as $key => $value) {
			...
			$linkDetailBook	= URL::createShopLink('default', 'book', 'detail', array('category_id' => $value['category_id'], 'book_id' => $value['id']), "$catNameURL/$bookNameURL-$catID-$bookID.html");
