    ...
    <div class='accordion' id='$accordionId'>
        <div class='accordion-item'>
            <h2 class='accordion-header' id='$headingId'>
                <button class='accordion-button' type='button' data-bs-toggle='collapse' data-bs-target='#$collapseId' aria-expanded='true' aria-controls='$collapseId'>" . $item['question'] . "</button>
            </h2>
