...
// Pagination
$paginationHTML        = $this->pagination->showPagination(URL::createLink('admin', 'blog', 'index'));
            ...
            <table class="adminlist" id="modules-mgr">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="10%"><?php echo $lblContent; ?></th>
                ...
                <tbody>
                    ...
                    if (!empty($this->Items)) {
                        ...
                        foreach ($this->Items as $key => $value) {
                            ...
                            $name        = $value['name'];
                            $content       = Helper::shortenString($value['content']);
                            $picture     = Helper::createImage('blog', '98x150-', $value['picture']);
                            $row        = ($i % 2 == 0) ? 'row0' : 'row1';
