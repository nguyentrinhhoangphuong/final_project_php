...
$inputContent      = Helper::cmsTextArea('form[content]', 'content', $dataForm['content'], 'inputbox required', 40);
...
if (isset($this->arrParam['id'])) {
    ...
    $picture    = '<img src="' . UPLOAD_URL . 'blog' . DS . '98x150-' . $dataForm['picture'] . '">';
...
$rowTextArea        = Helper::cmsRowForm('Content', $inputContent);
            ...
            <div class="width-100 fltlft">
                <fieldset class="adminform">
                    ...
                    <ul class="adminformlist">
                        <?php echo $rowName . $rowStatus . $rowOrdering . $rowPicture . $rowTextArea . $rowID; ?>
                    </ul>
                    <div class="clr"></div>
                    <div>
                        <?php echo $inputToken; ?>
