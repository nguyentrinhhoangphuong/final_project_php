...
class FaqModel extends Model
{
    ...
    {
        parent::__construct();
        $this->setTable(TBL_FAQ_CATEGORY);
    ...
    public function changeStatus($arrParam, $option = null)
    {
        ...
        if ($option['task'] == 'change-ajax-status') {
            ...
            $result = array(
                'id'        => $id,
                'status'    => $status,
                'link'      => URL::createLink('admin', 'faq', 'ajaxStatus', array('id' => $id, 'status' => $status))
            );
            $arrCategories    = $this->listItem($arrParam, array('task' => 'xml-faq'));
            XML::createXML($arrCategories, 'faq.xml');
            return $result;
        }
    ...
    public function saveItem($arrParam, $option = null)
    {
        ...
        if ($option['task'] == 'add') {
            ...
            $arrFaq    = $this->listItem($arrParam, array('task' => 'xml-faq'));
            XML::createXML($arrFaq, 'faq.xml');
