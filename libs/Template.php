...
class Template
{
	...
	public function load()
	{
		...
		if (file_exists($pathFileConfig)) {
			...
			$view->_vendorJs 	= $view->createLink($this->_folderTemplate . $arrCongif['dirVendorJs'], $arrCongif['fileVendorJs'], 'js');
			$view->_vendorCss 	= $view->createLink($this->_folderTemplate . $arrCongif['dirVendorCss'], $arrCongif['fileVendorCss'], 'css');
